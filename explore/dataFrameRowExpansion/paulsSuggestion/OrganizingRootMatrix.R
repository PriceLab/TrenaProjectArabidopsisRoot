...
#----------------------------------------------------------------------------------------------------
tbl <- tbl.root
#setting the "tbl.root" data frame to "tbl", to make life easier 
...
splitMultipleNames <- function(tbl)
  #creating the function "splitMultipleNames"
  #is used for one-row tables with multiple orf names in their rowname 
{
  tbl <- tbl.test[10,]
...
} # splitMultipleNames is tested; works perfectly ONLY with specified rows
#----------------------------------------------------------------------------------------------------
